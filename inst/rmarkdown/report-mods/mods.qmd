...
# colors
#  [1] "blue"        "yellow"      "green"       "red"         "teal"        "gray"       
#  [7] "lightblue"   "lightyellow" "lightgreen"  "pink"        "lightteal"   "sand"       
# [13] "darkblue"    "darkyellow"  "darkgreen"   "darkred"     "darkteal"    "darkgray"   

kthcol <- function(color_name) {
  pal <- ktheme::palette_kth_neo(18)
  if (!color_name %in% names(pal))
    stop("Please state one of these named colors: ", names(pal))
  pal[color_name] |> unname()
}
...
This report was generated at `r Sys.time()`. `r if (!params$use_minio) "Requests against Scopus API were made (no usage of object store \"Minio\")"`
...
bslib::value_box(
  "Publications", n_pubs, 
  theme_color = kthcol("sand"), 
  showcase = bsicons::bs_icon("book")
)

bslib::value_box(
  "Affiliations", n_affs, 
  theme_color = kthcol("lightteal"), 
  showcase = bsicons::bs_icon("hospital")
)

bslib::value_box(
  "Authors", n_authors, 
  theme_color = kthcol("lightgreen"), 
